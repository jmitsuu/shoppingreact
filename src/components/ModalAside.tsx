                      ...
                      >
                        <div className="flex">
                          ...
                          <div className="col ml-2">
                            <h1 className=" lowercase w-32 text-[0.7rem] ">
                              {el.title}
                            </h1>
                            <p className=" lowercase w-32 text-[0.7rem] ">
                              qtd:{" "}
                              <span className="font-bold"> {el.amout}</span>
                            </p>
                            <p className=" lowercase w-32 text-[0.7rem] ">
                              cor:{" "}
                              <span className="font-bold"> {el.color}</span>
                            </p>
                            <p className=" lowercase w-32 text-[0.7rem] ">
                              tamanho:{" "}
                              <span className="font-bold">{el.size}</span>
                            </p>
                          </div>
                        </div>
